...
int main(int argc, char *argv[])
{
    ...
    biR.biHeight = bi.biHeight * f;
    biR.biWidth = bi.biWidth * f;
    ...
    biR.biSizeImage = abs(bi.biHeight) * ((bi.biWidth * sizeof(RGBTRIPLE)) + padding);
    bfR.bfSize = bi.biSizeImage + sizeof(BITMAPFILEHEADER) + sizeof(BITMAPINFOHEADER);
